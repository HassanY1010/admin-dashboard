...
export default function TransactionsPage() {
  ...
  const columns: Column<any>[] = [
    ...
    },
    {
      key: "amount",
      header: "المبلغ",
      render: (row) => <span className="font-bold">{Number(row.amount).toLocaleString()} ر.ي</span>,
    },
    {
      key: "createdAt",
      header: "التاريخ",
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-bold text-right">المعاملات</h1>
        <p className="text-muted-foreground text-right">إدارة وتتبع المعاملات المالية</p>
      </div>
